...
File:   Morse.ino
HW/Lab: Homework 3, Morse code

Purp: Various morse code operations

Doc:  lab2 code, C notes from 155E, previous lab and homework pdfs
      for this class
...
void loop() {
  morseCharacter = determinePress();
  rgbInput(morseCharacter);
}
